...
public class UniversityDTO {
    ...
    public UniversityDTO(String id, String name, String shortName, String description, int foundedYear, String address, String city, String regio, String type, int totalStudents, int totalFaculties, boolean isDraft) {
        this.id = id;
        this.name = name;
    ...
    public void setRegion(String regio) {
        this.region = region;
    }
